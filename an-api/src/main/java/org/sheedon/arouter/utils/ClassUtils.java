package org.sheedon.arouter.utils;
...
import org.sheedon.arouter.thread.DefaultPoolExecutor;
...
//        通过是否存在sp中的multidex.version是不准确的，因为从低版本升级上来的用户，是包含这个sp配置的
        ...
        if (NotificationRouter.debuggable()) { // Search instant run support only debuggable
